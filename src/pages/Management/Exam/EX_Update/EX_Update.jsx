...
export default function EX_Update() {
  ...
  const handleSubmit = (e) => {
    ...
    fetch(`http://127.0.0.1:8000/api/updateExam/${id}`, {
      method : 'POST',
      headers : {
  ...
  return (
    <div className="container">
      ...
      <input type="hidden" name="id" defaultValue={exam.data.id} />
